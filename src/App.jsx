...
const SettingsModal = ({ settings, onClose, onSubmit }) => {
  const [blogTitle, setBlogTitle] = useState(settings.blogTitle || '雷娜塔的家');
  const [blogSubtitle, setBlogSubtitle] = useState(settings.blogSubtitle || "RENATA'S HOME");
