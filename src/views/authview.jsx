      ...
      <div className="auth-card">
        ...
        {!showSetup ? (
          <>
            ...
            {activeTab === 'register' && (
              <form className="auth-form" onSubmit={handleRegisterSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '15px' }}>
                ...
                <button type="submit" className="btn btn-primary btn-lg auth-submit-btn" style={{ background: 'linear-gradient(to bottom, #7ebd26 0%, #5d8e17 100%)', borderColor: '#5d8e17', width: '100%', marginTop: '10px' }}>註冊帳號</button>
              </form>
            )}
          ...
          <form className="auth-form" onSubmit={handleSetupSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '15px', maxHeight: '350px', overflowY: 'auto', paddingRight: '5px', scrollbarWidth: 'thin' }}>
            ...
            <button type="submit" className="btn btn-primary btn-lg auth-submit-btn" style={{ width: '100%', marginTop: '10px', background: 'linear-gradient(to bottom, #7ebd26 0%, #5d8e17 100%)', borderColor: '#5d8e17' }}>
              儲存並建立個人空間
            </button>
          </form>
        )}
